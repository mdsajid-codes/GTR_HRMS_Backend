...
@Builder
@Entity
@Table(name = "process_semi_finished_details")
public class ProcessSemiFinishedDetail {
    ...
    @JoinColumn(name = "process_semi_finished_id", nullable = false)
    private ProcessSemiFinished processSemiFinished;
