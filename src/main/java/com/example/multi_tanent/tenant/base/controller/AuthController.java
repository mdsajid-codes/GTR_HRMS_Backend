...
import com.example.multi_tanent.tenant.base.dto.UserRequest;
...
public class AuthController {
  ...
  public LoginResponse login(@RequestBody UserRequest userRequest) {
    try {
      ...
      User u = users.findByEmail(userRequest.getEmail()).orElseThrow(() -> new RuntimeException("User not found"));
      ...
      TenantPlan plan = u.getPlan();
      return new LoginResponse(token, roles, plan);
    } finally {
